...
// Command: opt -load LLVMCallDependence.dylib -call-dependence file.bc
...
struct AllCallDependencePass : public FunctionPass{
    ...
    AllCallDependencePass() : FunctionPass(ID), DA(nullptr), DT(nullptr) {}
...
char AllCallDependencePass::ID = 0;
static RegisterPass<CallDependencePass> X("call-dependence-smartlog", "Extract call dependence needed by SmartLog");
static RegisterPass<AllCallDependencePass> Y("call-dependence", "Extract call dependence");
